...
ACTIVE_CONNECTIONS = Gauge(
    "portfolio_active_connections", "Number of active connections for portfolio service"
)
...
DATABASE_CONNECTIONS = Gauge(
    "portfolio_database_connections", "Number of active database connections"
)

HOLDINGS_COUNT = Gauge(
    "portfolio_holdings_count", "Total number of holdings across all portfolios"
)

PORTFOLIO_VALUE = Gauge(
    "portfolio_total_value_usd", "Total portfolio value in USD", ["portfolio_id"]
)
